...
var productController = __importStar(require("../controllers/product"));
var orderController = __importStar(require("../controllers/order"));
var jwtToken_1 = require("../config.ts/jwtToken");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                app.get("/test", jwtToken_1.verifyToken, function (req, res) {
